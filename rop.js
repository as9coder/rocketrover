class Rope {
  constructor(nlink, orbiter, yOffset) {
    this.nlink = nlink;
    this.orbiter = orbiter;
    this.yOffset = yOffset; // Adjust this to control the height of the rope
    ...
    Composite.add(rects, Constraint.create({
      pointA: { x: orbiter.body.position.x, y: orbiter.body.position.y + yOffset }, // Adjust yOffset to control the height of attachment
